...
Unforunately Capital Apple is a different word, I would have to set it up again...
...
Adding this line to update the repo to get it to rebuild since it like, broke? Uping the number here every time I do this: 7
