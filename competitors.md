...
At any time, Mauled by Concrete may **Seperate**, even in the middle of attacks. Blood Sport is connected to Brutalized by strings of arcing energy, which deals 20 light contact damage, however the energy will take a second to re-attach if Blood Sport teleports. Blood Sport will detect any actions with cast times or channeled actions and if recognized as dangerous and if in Avnlyla's FoV, immediately return to Brutalized to attempt to **Spite Parry** in time. If it gets close, it will %%at**Thrill Strike**++% Avnlyla, attempting to dash at her before entering an exploding punch that deals 30 normal damage as an AoE that grounds and applies a jump-disabling light snare. Blood Sport can also at range cast %%at**Shocking Rays**++% from its hands, making a large sweeping beam that deals 30 normal damage. 

Blood Sport can occasionally %%at**Double Down**++% on attacks, repeating their damage with its own attack. After a **Heavy Swing**, Blood Sport manifests the axe to them before rapidly dashing at Avnlyla to swing at her. It can catch the **Spinning Throw** at its peak and redirect it with greater speed at Avnlyla. It can follow up on a **Uppercut**, teleporting to where Avnlyla will land to attempt to kick her back in.

Mauled by Concrete will attempt to %%at**Trophy Kill**++% Avnlyla if she takes three hits from them in four seconds, or if she takes a hit while under 30% health. It will stop attacking and Mauled by Concrete will enter a channel where it is **Possessed** and all its abilities are disabled; It will only slowly move, brandishing and readying the axe. At some point in the next 5 seconds, it will suddenly teleport behind Avnlyla before swinging to decapitate her, dealing 70 heavy damage. If Mauled by Concrete is ever below 15% health during this, it will not wait, and will instead attempt this attack as soon as possible with a more telegraphed teleport.
