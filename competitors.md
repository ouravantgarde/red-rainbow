...
Competitors have horrific, surreal, and depressive themes, drawing inspiration from esoteric ideas and subcultures in contrast to more grounded or shared theming among other enemies. They also push the design space of combat, pushing and showing limits. Competitors are endgame enemies with intentionally obtuse and demanding kits that often require Avnlyla to deal with them on *their* terms. Luckily, even in Noxipolis, Competitors are the rarest enemies in the game, making up only 15% of enemies in arenas. An arena very rarely has more than two rolls for Competitors.
...
Arabic: **Zankha** - Putrid smell of raw meat

Tagalog: **Malansá** - Smell of raw meat/fish
...
Mauled by Concrete moves with skill and deliberation. The axe is a fire axe with a larger than usual head.

Brutalized is a slim humanoid made of rough concrete. It has ball joints, of which the balls are and reveal the inside of Brutalized to be stringy, wound flesh. It has a crater in its right hip, where rebar sticks out , while it's left wrist is missing the lower half revealing rebar similar to bone, and the left shoulder has a smaller chunk missing with rebar seemingly impaled through it. It has a large gash in the concrete of its chest, very barely revealing more flesh. Brutalized wears a mask. The mask has three holes where the mouth would be, from which blood leaks aswell as from the lower mask opening. The mask appeared bloodstained, and has a red circle where the left eye is, and the right eye has a hole for it surrounded by messy rings of green and orange. It has large, stringy, almost cable like black hair which largely spreads out to one side.
...
Killed by Brutalized: *Broken bones.*

Killed by Blood Sport including Spite Parry: *Outfought and out-adrenalined.*
...
%%at**Scrub**++% - Bubbles attempt to cover the entire arena in a grid which slowly shifts around.

%%at**Splash**++% - Bubbles gather around Saponificare before releasing groups of 7 in waves aimed at the player every 2 seconds, which bounce off the "bounds" of the arena or any walls present, before slowing down after a distance traveled after a bounce.

%%at**Soak**++% - Bubbles will surround enemies, rotating and pulsing inwards and outwards around them. Bubbles are dispersed three at a time to an enemy, until every enemy has three bubbles. This is repeated until every enemy has 6 bubbles, and so forth. If an enemy dies, the bubbles are randomly dispersed to other enemies.

**Clean** will always stop after 10 seconds
...
CH2O floats around, with no care for its orientation. It is capable of %%pa**Fading**++%, slipping behind thin air at any time, often only existing physically for seconds at a time. When **Fading** back in, CH20 can immediately enter *any* ability. While **Fading**, it is not visible or interactable at all. However it can %%at**Sharpen**++% a random area near Avnlyla, making latent slashes in the air that detonate after a second, rapidly cutting through the air for 40 normal damage.
...
Killed by sharp attacks: It reaches the bones...
...
%%pa**String & Leeched**++% corpses are reanimated. Enemies will always remain within a distance of the Corpse Angel, often resulting in them being dragged or flung to keep up. Enemies have slightly increased movespeed and, when killed, explode into a massive spherical spread of visceral projectiles that deal 30 normal damage. It will obsessively attempt to attach a new corpse every six seconds.

It will flutter around the arena, trying to stay not too far from Avnlyla and attempting volleys of %%at++**Toxic Blood**++%, a spread of fetid projectiles that deal 30 normal damage in an AoE, splashing out 20 light damage droplets of liquid. It can hover and fly with immense speed, often flying directly past to %%at**Pester**++% Avnlyla, afflicting her with %%at**Hemorrhage** and dealing 20 light damage, often dragging enemies directly into her.

Occasionally two of its puppets will be %%pa**Uplifted**++%, releasing more tendril into the air to give the enemies more space. **Uplifted** enemies have 20% faster animations. Puppets who have been damaged below 40% will be %%at**Spent Corpses**++%, and will likely see their strings reel and whip their bodies off, forcibly detatching them and killing them instantly, flinging their corpse at Avnlyla at great speed to explode.
